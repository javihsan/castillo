...
<meta name="description" content="Web del Mesón Castillo, el bar del botellín, menús diarios. Tu lugar de reunión en El Gorronal, Villalba. Deporte y diversión.">
<meta name="keywords" content="mesón,bar,botellín,copas,Villalba,sierra,Madrid,comedor,menú,restaurante,deporte,El Gorronal">
...
function pintaCaballero(num){
	...
	if (num==1){
		...
		color = 'morado'
		url = 'http://www.castillocd.com'
		textoalt = 'Ir a Deporte'
	}	
	else if (num==5){ 
		color = 'azul'
		url += 'noticias'
		url = 'javascript:alert("Estamos trabajando en ello")'  
	...
	if (num!=<%=menu%>){
		str += "<a ";
		if (num==4)  str +="target='_blan'";
		str +="href='"+url+"' onMouseOver=\"Menu_cambia("+num+",'"+color+"',2)\" onMouseOut=\"Menu_cambia("+num+",'"+color+"',1)\">";
...
function pintaArea(num){
	...
	x = 10+100*(num-1)
	if (num!=<%=menu%>){
		str2 += "<area shape=\"rect\" coords=\""+x+",1,"+(x+85)+",26\""
		if (num==4) str2 +="target='_blan'";
		str2 += "href='"+url+"' onMouseOver=\"Menu_cambia("+num+",'"+color+"',2)\" onMouseOut=\"Menu_cambia("+num+",'"+color+"',1)\" alt=\""+textoalt+"\" title=\""+textoalt+"\">"
	}
	else{
		str2 += "<area shape=\"rect\" coords=\""+x+",1,"+(x+85)+",26\""
		if (num==4) str2 +="target='_blan'";
		str2 += "href='"+url+"' alt=\""+textoalt+"\" title=\""+textoalt+"\">"
	}	
	document.write(str2) 
}
...
<!-- ********* Cabecera ************* -->
<tr>
	<td align="center" valign="top" colspan="5" height="71px">
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">    
		<tr>
		<td width="380px" align="center"><SPACER type="block"></td>
	...
	<td valign="bottom" colspan="5">
		...
		<tr>
			<td align="right" valign="midlle" width="120px">
				<a href="inicio"><img src="../../imagenes/logo.gif" alt="Ir al inicio" title="Ir al inicio" border="0"></a>
			</td>
